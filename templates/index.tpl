	...
	<body>
		...
		<div class="row">
			...
			<div class="col-md-9">
				...
				<div class="menuItem">
					<a href="addToCart.php?id={$product.id}" onClick="alert(\'Adicionado\');">
					<img src="{$product.url}" style="height: 100%; width=100%;"/>
					{$product.name} - Preço:{$product.price}€  - Clique para adicionar ao carrinho
					</a>
				</div>
				{/foreach}
